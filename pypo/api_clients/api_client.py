...
api_config['version_url'] = 'abcast/base/version/?format=json&apikey=%%api_key%%'
...
api_config['register_component'] = 'abcast/base/register-component/?format=json&apikey=%%api_key%%&component=%%component%%'
...
api_config['show_schedule_url'] = 'abcast/base/recorded-shows/?format=json&apikey=%%api_key%%'
...
api_config['export_url'] = 'abcast/base/get-schedule/?format=json&apikey=%%api_key%%'
...
api_config['get_bootstrap_info'] = 'abcast/base/get-bootstrap-info/?format=json&apikey=%%api_key%%'
...
api_config['update_stream_setting_table'] = 'abcast/base/update-stream-settings/?format=json&apikey=%%api_key%%'
